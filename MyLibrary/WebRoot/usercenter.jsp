...
<body>
    ...
    <div style="float:left"><h2>&nbsp;<img src="images/hotel.png" width="32" width="68" />&nbsp;图&nbsp;书&nbsp;信&nbsp;息：</h2></div>
     <p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
     <div style="float:left">
        </div>
       <form action = "showUserOwnBook.jsp" method = "post"> 
        <fieldset style='width:80%'>
        	<legend>查询条件</legend>
        	<p>&nbsp;</p>
        		<p style="font-family:华文仿宋" style="font-size:64px" style="font-weight:200">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong> 你的用户名</strong>：
            	<input type="text" name="username" id = "book"/></p>
    ...
    <% 
		...
		<table bgcolor = "#CCCCCC" cellspacing = 1 cellpadding = 5 width = 100% border=2>
			...
			<tr bgcolor = "#FFFFFF">
				...
				<td align = "center"><a href='operateBook.jsp?id=<%= rs.getInt("book_id")%>&bookname=<%=rs.getString("book_name")%>&booknum=<%=rs.getString("book_num")%>&bookowner=<%=rs.getString("book_owner")%>&booksource=<%=rs.getString("book_source")%>&bookstatus=<%=rs.getString("book_status")%>&booktype=<%=rs.getString("book_type")%>' onclick='return confirm("确定借阅该图书？")'>借阅图书</a>
				</td>
				</td>
			</tr>
			<%
